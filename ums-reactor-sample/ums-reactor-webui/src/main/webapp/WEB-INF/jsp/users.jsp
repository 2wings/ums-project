...
<body>
	<h1 id='banner' class="usercss" >Reactor User Management System Demo</h1>
	<hr/>
	
	<table id='tableUsers' class="usercss" >
		 
	</table>
	
	<div id='controlBar' class="usercss" >
